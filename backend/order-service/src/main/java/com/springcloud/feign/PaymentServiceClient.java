...
import com.springcloud.dto.PaymentResponse;
...
public interface PaymentServiceClient {
    ...
    PaymentResponse refundEscrow(@RequestBody EscrowRefundRequest request);
    
    @PostMapping("/api/payment/release-escrow")
    PaymentResponse releaseEscrow(@RequestBody EscrowReleaseRequest request);
