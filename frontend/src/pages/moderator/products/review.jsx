...
const productSubmissions = [
  { 
    ...
    category: 'Fruits',
    farmer: 'Sunshine Berry Farm',
    description: 'Fresh organic blueberries, sustainably grown without pesticides',
    price: '$4.99/pint',
  ...
  { 
    ...
    description: 'Handcrafted goat cheese made with traditional methods',
    price: '$8.50/8oz',
  ...
  { 
    ...
    description: 'Stone-ground organic wheat flour from heirloom grain varieties',
    price: '$5.75/lb',
  ...
  { 
    ...
    category: 'Vegetables',
    farmer: 'Colorful Acres',
    description: 'Mix of purple, orange, yellow and white heirloom carrots',
    price: '$3.99/bunch',
  ...
  { 
    ...
    description: 'Raw, unfiltered wildflower honey from sustainable hives',
    price: '$12.00/jar',
  ...
  { 
    ...
    description: 'Humanely raised pasture chickens, no antibiotics or hormones',
    price: '$5.99/lb',
    submittedOn: '2025-06-18',
    priority: 'High',
  ...
  { 
    ...
    description: 'Assorted heirloom tomato varieties, grown sustainably',
    price: '$4.50/lb',
    submittedOn: '2025-06-20',
    priority: 'Medium',
    status: 'Pending Review'
  ...
  { 
    ...
    description: 'Cultured butter from grass-fed cows, traditional churning method',
    price: '$6.99/8oz',
    submittedOn: '2025-06-19',
    priority: 'Low',
    status: 'Pending Review'
