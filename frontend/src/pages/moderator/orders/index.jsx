...
const orders = [
  { 
    ...
    products: ['Fresh Farm Milk', 'Organic Eggs', 'Mixed Vegetables'],
    amount: '$52.75',
  ...
  { 
    ...
    products: ['Organic Eggs', 'Grass-Fed Beef'],
    amount: '$32.74',
  ...
  { 
    ...
    products: ['Grass-Fed Beef', 'Organic Tomatoes'],
    amount: '$89.99',
  ...
  { 
    ...
    products: ['Seasonal Fruits', 'Organic Honey'],
    amount: '$45.50',
  ...
  { 
    ...
    products: ['Mixed Vegetables', 'Fresh Farm Milk', 'Organic Eggs'],
    amount: '$38.25',
  ...
  { 
    ...
    products: ['Organic Honey', 'Seasonal Fruits'],
    amount: '$28.99',
  ...
  { 
    ...
    products: ['Organic Tomatoes', 'Grass-Fed Beef', 'Organic Eggs'],
    amount: '$75.25',
  ...
  { 
    ...
    products: ['Fresh Farm Milk', 'Mixed Vegetables'],
    amount: '$22.50',
