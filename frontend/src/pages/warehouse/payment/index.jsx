  ...
  return (
    <div className="min-h-screen bg-white-50 flex">
      ...
      <main className="flex-1 p-6 lg:p-10">
        {/* Page Title */}
        <div className="mb-6">
          <h1 className="text-2xl lg:text-3xl font-bold text-green-900 flex items-center gap-2 mb-2">
            <span className="text-3xl lg:text-4xl">💳</span> Payment Overview
          </h1>
          <p className="text-green-700 text-sm">Manage and review all warehouse payments and transactions.</p>
        </div>
        {/* Notification Banner */}
        <div className="mb-4">
