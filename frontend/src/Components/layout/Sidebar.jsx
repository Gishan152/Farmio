  ...
  const menuItems = {
    ...
    moderator: [
      ...
      { 
        name: 'Pricing', 
        icon: <PricingIcon />, 
        path: '/moderator/pricing',
        submenu: [
          { name: 'Daily Prices', path: '/moderator/pricing' },
          { name: 'Price History', path: '/moderator/pricing/history' },
          { name: 'Price Analytics', path: '/moderator/pricing/analytics' }
        ] 
      },
