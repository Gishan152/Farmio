...
// Sri Lankan support tickets data
const supportTickets = [
  { 
    id: 'TKT-001', 
    subject: 'Order Delivery Delay Issue',
    description: 'I ordered Ceylon spices 5 days ago and it hasn\'t arrived yet. The tracking hasn\'t updated in 48 hours.',
    customer: {
      name: 'Kumara Perera',
  ...
  { 
    id: 'TKT-002', 
    subject: 'Quality Issue with Ceylon Tea',
    description: 'The Ceylon tea I received doesn\'t match the quality shown on the website. It appears to be a different grade.',
    customer: {
      name: 'Amali Fernando',
      email: 'amali.f@email.com',
      type: 'Buyer',
    },
    createdAt: '2025-06-20 09:45 AM',
    priority: 'Medium',
    status: 'Open',
    assignedTo: 'Unassigned',
  ...
  { 
    ...
    description: 'I made a payment for my order through BOC bank transfer but it still shows as pending in the system.',
    customer: {
  ...
  { 
    id: 'TKT-004', 
    subject: 'Unable to Update Rice Inventory',
    description: 'I\'m trying to update my rice farm inventory but keep getting an error message about invalid quantities.',
    customer: {
      name: 'Anura Kumara',
      email: 'anura.k@ricefarm.com',
      type: 'Farmer',
    },
    createdAt: '2025-06-20 02:45 PM',
    priority: 'Medium',
    status: 'In Progress',
    assignedTo: 'Pasan Wickramasinghe',
    category: 'Technical Issue'
  },
  { 
    id: 'TKT-005', 
    subject: 'Need to Change Delivery Address',
    description: 'I need to update the delivery address for my upcoming tea order scheduled for tomorrow to Kandy instead of Colombo.',
    customer: {
      name: 'Lakshmi Gooneratne',
  ...
  { 
    id: 'TKT-006', 
    subject: 'Dambulla Warehouse Access Problem',
    description: 'My access card is not working at the Dambulla warehouse gate. Need urgent assistance.',
    customer: {
      name: 'Ranjan Perera',
      email: 'ranjan.p@storagesol.com',
      type: 'Warehouse Owner',
    },
    createdAt: '2025-06-18 04:30 PM',
    priority: 'Medium',
    status: 'In Progress',
    assignedTo: 'Dilshan Wickrama',
    category: 'Access Issue'
  },
  { 
    id: 'TKT-007', 
    subject: 'Refund Request for Damaged Spices',
    description: 'Several spice packages in my order were damaged during delivery. Requesting a refund for these items.',
    customer: {
    ...
    priority: 'Medium',
    status: 'Resolved',
    assignedTo: 'Kanchana Perera',
    category: 'Refund Request'
  },
  { 
    id: 'TKT-008', 
    subject: 'Transport Schedule Mix-up in Colombo',
    description: 'I was scheduled to pick up produce at 9am at the Colombo Central depot but the warehouse staff says it\'s scheduled for tomorrow.',
    customer: {
      name: 'Thilak Weerasinghe',
      email: 'thilak.w@ceylontransport.com',
...
const sampleMessages = [
  {
    id: 1,
    sender: 'Kumara Perera',
    senderType: 'Customer',
    message: 'I ordered Ceylon spices 5 days ago and it hasn\'t arrived yet. The tracking hasn\'t updated in 48 hours. Can you please help me locate my order?',
  ...
  {
    id: 3,
    sender: 'Nirmal Jayasinghe',
    senderType: 'Moderator',
    message: 'Hello Kumara, I\'m reviewing your order now. Could you please provide your order number so I can look into this for you?',
  ...
  },
  {
    ...
    sender: 'Nirmal Jayasinghe',
    senderType: 'Moderator',
    message: 'I\'ve located your order. It appears there was a delay at the Colombo distribution center due to the heavy rains yesterday. I\'ve contacted our shipping department and they\'ve informed me your order is out for delivery today. You should receive it by 5 PM. I\'ll also make sure the tracking is updated. Please let me know if you don\'t receive it by end of day.',
