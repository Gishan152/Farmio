...
const SettingsPage = () => {
  ...
  const activityLog = [
    ...
    { action: 'Updated product status', timestamp: '2025-06-21 10:22 AM', details: 'Product ID: SL-CINN-458' },
    { action: 'Approved vendor application', timestamp: '2025-06-21 11:45 AM', details: 'Vendor: Ratnapura Spice Gardens' },
    { action: 'Resolved support ticket', timestamp: '2025-06-21 01:30 PM', details: 'Ticket ID: TKT-002' },
    { action: 'Updated inventory count', timestamp: '2025-06-20 02:15 PM', details: 'Product ID: SL-TEA-112' },
