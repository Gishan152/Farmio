...
import { useWasteAgent } from '../../../Contexts/Farmer/WasteAgentContext';
import WasteAgentCard from '../../../Components/Farmer/WasteAgentCard';
import HireRequestForm from '../../../Components/Farmer/HireRequestForm';
...
export default function WasteAgent() {
    ...
    return (
        <div className="p-4 bg-gray-40 dark:bg-gray-100 min-h-screen">
            <div className="max-w-7xl mx-auto space-y-4">
                {/* Header */}
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-semibold dark:text-gray-100">Waste Management</h1>
                    </div>
                    <button
                        onClick={() => setShowRequests(!showRequests)}
                        className="flex items-center mt-2 px-4 py-2 border border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition duration-200 text-sm"
                    >
